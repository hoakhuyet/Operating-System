...
if __name__ == '__main__':
    ...
    fileLog.write('Process     Thoi gian cho     Thoi gian hoan thanh')
    fileLog.write('\n----------------------------------------------------')
    standbyTime = 0.0
    for i in terminated:
    ...
    fileLog.write('\nThoi gian hoan thanh trung binh: ' + str(standbyTime / len(terminated) + timeProcess / len(terminated)))
    fileLog.close()
    ...
    _style = ('Courier', 25)
    title.write('First Come First Served', font=_style)
    color1 = 'red'
    color2 = 'blue'
