...
def initializeData():
    ...
    processList = []
    temp = None     # Bien trung gian cho ham doi cho
...
if __name__ == '__main__':
    ...
    while True:
        ...
        while ctrl.processList[ctrl.processListSize - 1].arrivalTime == ctrl.timer and ctrl.processListSize > 0:
            ctrl.readyQueue[ctrl.readyQueueSize] = ctrl.processList[ctrl.processListSize - 1]
        ...
        if ctrl.flag == 1:
            ...
            if ctrl.running.duration == 0:
                ...
                ctrl.flag = 0
                # Neu tien trinh xu dung het time quantum
            elif ctrl.timer - ctrl.running.arrivalTime == TIMEQUANTUM - 1:
                ctrl.flag = 0
                ctrl.running.arrivalTime = ctrl.timer + 1
                ctrl.readyQueue[ctrl.readyQueueSize] = ctrl.running
                fileLog.write('[Move ' + ctrl.processList[ctrl.processListSize - 1].processID + ' to Ready Queue!]  ')
                ctrl.readyQueueSize += 1
    ...
    _style = ('Courier', 25)
    title.write('Round Robin', font=_style)
    color1 = 'red'
    color2 = 'blue'
